...
if(empty($_POST['cpdMed']) || empty($_POST['cpfPaciente'])){
    header('Location: P_agendamento-consulta.php');
    exit();
}

    $nomePaciente = mysqli_real_escape_string($conexao, $_POST['paciente']);
    $cpfPaciente = mysqli_real_escape_string($conexao, $_POST['cpfPaciente']);
    $TelPaciente = mysqli_real_escape_string($conexao, $_POST['medico']);
    $nascPaciente = mysqli_real_escape_string($conexao, $_POST['cpdMed']);
    $situacao = mysqli_real_escape_string($conexao, $_POST['horario']);
